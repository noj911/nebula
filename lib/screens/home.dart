...
import 'package:nebula/bloc/netflix_bloc.dart';
import 'package:nebula/cubit/animation_status_cubit.dart';
import 'package:nebula/widgets/highlight_movie.dart';
import 'package:nebula/widgets/movie_box.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void didChangeDependencies() {
    if (GoRouterState.of(context).uri.toString() != '/home/tvshows') {
